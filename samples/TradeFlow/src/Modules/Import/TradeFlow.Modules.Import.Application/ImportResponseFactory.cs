...
public static class ImportResponseFactory
{
    ...
    public static CertificateOfOriginResponse ToCertificateOfOriginResponse(CertificateOfOrigin coo) => new(
        coo.Id,
        coo.TenantId,
        coo.FileId,
        coo.CiId,
        ...
        coo.IssuedOn,
        coo.ExpiryDate,
        coo.PreferentialEligible,
        coo.Status == CertificateOfOriginStatus.Mismatch,
        coo.MismatchReason);

    // ── COO Issuer Registry ─────────────────────────────────────────────

    public static CooIssuerRegistryResponse ToCooIssuerRegistryResponse(CooIssuerRegistry registry) => new(
        registry.Id,
        registry.TenantId,
        registry.Country,
        registry.IssuerName,
