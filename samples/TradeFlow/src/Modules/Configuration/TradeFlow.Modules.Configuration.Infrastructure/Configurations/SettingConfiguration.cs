...
public sealed class SettingConfiguration : IEntityTypeConfiguration<Setting>
{
    public void Configure(EntityTypeBuilder<Setting> builder)
    {
        ...
        builder.Property(s => s.Id)
            .HasConversion(
                id => id.Value,
                value => TradeFlow.Modules.Configuration.Domain.ValueObjects.SettingId.From(value))
            .IsRequired();

        builder.Property(s => s.Key)
            .HasConversion(
                key => key.Value,
                value => TradeFlow.Modules.Configuration.Domain.ValueObjects.SettingKey.FromString(value))
            .IsRequired()
            .HasMaxLength(256);
