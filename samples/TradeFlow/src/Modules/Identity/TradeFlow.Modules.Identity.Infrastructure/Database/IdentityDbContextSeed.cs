...
using TradeFlow.Shared.Infrastructure.Authorization;
using TradeFlow.Modules.Identity.Domain.Authorization;
...
namespace TradeFlow.Modules.Identity.Infrastructure.Database;
...
public static class IdentityDbContextSeed
{
    ...
    private static async Task SeedRolePermissionsAsync(IdentityDbContext context, ILogger logger)
    {
        ...
        if (firstUser == null)
        {
            ...
            var systemUser = User.Create(
                systemUserId,
                Email.Create("system@TradeFlow.local").Value,
        ...
        string environment)
    {
        ...
        var userData = new[]
        {
            new
            {
                Email = "admin@TradeFlow.com", UserName = "admin", FirstName = "System",
            ...
            new
            {
                Email = "user1@TradeFlow.com", UserName = "user1", FirstName = "Jane",
                LastName = "Doe",
