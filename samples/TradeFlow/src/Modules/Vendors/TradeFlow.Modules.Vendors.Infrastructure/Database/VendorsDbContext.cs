...
namespace TradeFlow.Modules.Vendors.Infrastructure.Database;
    ...
    : ModuleDbContext(options, currentTenant, currentUser, dispatcher, serviceProvider), IUnitOfWork
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Vendor>(builder =>
        {
            ...
            builder.OwnsMany(v => v.Documents, d =>
            {
                d.WithOwner().HasForeignKey("VendorId");
                d.HasKey("VendorId", nameof(VendorDocument.Id));
                d.ToTable("vendor_documents");
            });
        });
    }
}