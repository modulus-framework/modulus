...
using TradeFlow.Modules.Costing.Infrastructure.Repositories;

namespace TradeFlow.Modules.Costing.Infrastructure;
...
public sealed class CostingModule : ModulusModule
{
        ...
        IConfiguration configuration)
    {
        ...
        services.AddScoped<IRevaluationRunRepository, EfRevaluationRunRepository>();
        services.AddScoped<ILandedCostRevaluationService, LandedCostRevaluationService>();
