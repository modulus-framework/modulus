...
namespace TradeFlow.Modules.Tenants.Infrastructure.Database;
...
public sealed class TenantsDbContextFactory : IDesignTimeDbContextFactory<TenantsDbContext>
{
    public TenantsDbContext CreateDbContext(string[] args)
    {
        ...
        if (string.IsNullOrWhiteSpace(connectionString))
        {
            connectionString = "Host=localhost;Port=5432;Database=TradeFlow_tenants;Username=postgres;Password=postgres";
        }
