...
using CommandInvoiceLineDto = TradeFlow.Modules.Finance.Application.Commands.InvoiceLineDto;
using CommandJournalLineDto = TradeFlow.Modules.Finance.Application.Commands.JournalLineDto;

namespace TradeFlow.Modules.Finance.Presentation;
