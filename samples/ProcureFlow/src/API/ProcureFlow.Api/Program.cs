...
using ProcureFlow.Modules.Notifications.Presentation;
...
[assembly: System.Runtime.CompilerServices.InternalsVisibleTo("ProcureFlow.Modules.Identity.UnitTests")]
[assembly: System.Runtime.CompilerServices.InternalsVisibleTo("ProcureFlow.E2ETests")]
...
[
    ProcureFlow.Modules.Identity.Application.AssemblyReference.Assembly,
    ProcureFlow.Modules.Tenants.Application.AssemblyReference.Assembly,
    ...
    ProcureFlow.Modules.TradeFinance.Application.AssemblyReference.Assembly,
    ProcureFlow.Modules.Import.Application.AssemblyReference.Assembly,
...
[
    typeof(ProcureFlow.Modules.Identity.Domain.Events.UserCreatedDomainEvent).Assembly,
    typeof(ProcureFlow.Modules.Tenants.Domain.Events.TenantCreatedDomainEvent).Assembly,
    ...
    typeof(ProcureFlow.Modules.TradeFinance.Domain.Events.LcIssuedDomainEvent).Assembly,
    typeof(ProcureFlow.Modules.Import.Domain.Events.ImportFileClosedDomainEvent).Assembly,
...
// database so EnsureCreated is not a no-op on the shared ProcureFlow DB.
...
builder.Services.AddDataProtection()
    ...
    .SetApplicationName("ProcureFlow");
...
// Modulus module system: ProcureFlowHostModule's [DependsOn] list declares every
...
app.MapModulusEndpoints(
    ProcureFlow.Modules.Identity.Presentation.AssemblyReference.Assembly,
    ProcureFlow.Modules.Tenants.Presentation.AssemblyReference.Assembly,
    ...
    ProcureFlow.Modules.TradeFinance.Presentation.AssemblyReference.Assembly,
