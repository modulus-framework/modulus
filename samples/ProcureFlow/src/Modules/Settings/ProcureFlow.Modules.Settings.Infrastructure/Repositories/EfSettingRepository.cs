...
namespace ModulusSample.Modules.Settings.Infrastructure.Repositories;

public sealed class EfSettingRepository(SettingsDbContext context) : ISettingRepository
{
