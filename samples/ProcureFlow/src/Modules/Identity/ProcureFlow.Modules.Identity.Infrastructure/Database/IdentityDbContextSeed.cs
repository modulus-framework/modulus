...
using ProcureFlow.Shared.Infrastructure.Authorization;
using ProcureFlow.Modules.Identity.Domain.Authorization;
...
public static class IdentityDbContextSeed
{
    ...
    private static async Task SeedRolePermissionsAsync(IdentityDbContext context, ILogger logger)
    {
        ...
        if (firstUser == null)
        {
            ...
            var systemUser = User.Create(
                systemUserId,
                Email.Create("system@procureflow.local").Value,
        ...
        string environment)
    {
        ...
        var userData = new[]
        {
            new
            {
                Email = "admin@procureflow.com", UserName = "admin", FirstName = "System",
            ...
            new
            {
                Email = "user1@procureflow.com", UserName = "user1", FirstName = "Jane",
                LastName = "Doe",
