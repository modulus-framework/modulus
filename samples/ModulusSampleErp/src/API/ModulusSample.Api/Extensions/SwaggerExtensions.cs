...
{
    private const string ApiTitle = "Modulus Sample ERP API";
        ...
        IConfiguration configuration)
    {
        ...
        services.AddSwaggerGen(options =>
        {
            ...
            options.SwaggerDoc(ApiVersion, new OpenApiInfo
            {
                ...
                Version = ApiVersion,
                Description = """
                    Modulus Sample ERP API with modular architecture.
                ...
                {
                    Name = "Modulus Sample API Support",
                    Email = "support@modulussample.com",
                    Url = new Uri("https://modulussample.com")
                },
        ...
        IConfiguration configuration)
    {
        ...
        {
            options.SwaggerEndpoint("/swagger/v1/swagger.json", "Modulus Sample ERP API v1");
            options.RoutePrefix = "swagger";
            options.DocumentTitle = "Modulus Sample ERP API Documentation";
