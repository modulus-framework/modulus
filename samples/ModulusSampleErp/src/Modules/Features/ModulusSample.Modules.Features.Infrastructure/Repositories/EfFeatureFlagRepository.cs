...
namespace ModulusSample.Modules.Features.Infrastructure.Repositories;

public sealed class EfFeatureFlagRepository(FeaturesDbContext context) : IFeatureFlagRepository
{
