...
namespace ModulusSample.Modules.Settings.Infrastructure.Configurations;
...
public sealed class SettingConfiguration : IEntityTypeConfiguration<Setting>
{
    public void Configure(EntityTypeBuilder<Setting> builder)
    {
        ...
        builder.Property(s => s.Key)
            .HasConversion(
                key => key.Value,
                value => ModulusSample.Modules.Settings.Domain.ValueObjects.SettingKey.FromString(value))
            .IsRequired()
            .HasMaxLength(256);
