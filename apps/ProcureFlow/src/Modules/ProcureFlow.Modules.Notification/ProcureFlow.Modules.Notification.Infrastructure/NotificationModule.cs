...
/// <summary>
/// Composition root for the Notification module. Registers the module's own
...
/// </summary>
public sealed class NotificationModule : ModulusModule
{
    public override void ConfigureServices(
        IServiceCollection services,
        IConfiguration configuration)
    {
        services.AddModuleDatabase<NotificationDbContext>(options =>
            options.UseNpgsql(configuration.GetConnectionString("Notification")
