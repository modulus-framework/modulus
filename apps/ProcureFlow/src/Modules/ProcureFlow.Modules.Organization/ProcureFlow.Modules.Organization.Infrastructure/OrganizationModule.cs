...
using ProcureFlow.Modules.Organization.Application;
namespace ProcureFlow.Modules.Organization.Infrastructure;

/// <summary>
/// Composition root for the Organization module. Registers the module's own
...
/// </summary>
public sealed class OrganizationModule : ModulusModule
{
    public override void ConfigureServices(
        IServiceCollection services,
        IConfiguration configuration)
    {
        services.AddModuleDatabase<OrganizationDbContext>(options =>
            options.UseNpgsql(configuration.GetConnectionString("Organization")
