...
using ProcureFlow.Modules.Payment.Application;
namespace ProcureFlow.Modules.Payment.Infrastructure;

/// <summary>
/// Composition root for the Payment module. Registers the module's own
...
/// </summary>
public sealed class PaymentModule : ModulusModule
{
    public override void ConfigureServices(
        IServiceCollection services,
        IConfiguration configuration)
    {
        services.AddModuleDatabase<PaymentDbContext>(options =>
            options.UseNpgsql(configuration.GetConnectionString("Payment")
