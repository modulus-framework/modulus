...
using ProcureFlow.Modules.Audit.Application;
namespace ProcureFlow.Modules.Audit.Infrastructure;

/// <summary>
/// Composition root for the Audit module. Registers the module's own
...
/// </summary>
public sealed class AuditModule : ModulusModule
{
    public override void ConfigureServices(
        IServiceCollection services,
        IConfiguration configuration)
    {
        services.AddModuleDatabase<AuditDbContext>(options =>
