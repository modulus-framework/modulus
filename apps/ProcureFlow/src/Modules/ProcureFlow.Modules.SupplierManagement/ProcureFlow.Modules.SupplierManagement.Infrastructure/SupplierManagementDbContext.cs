...
/// <summary>
/// The SupplierManagement module's own DbContext. Each module owns its context
...
/// </summary>
public sealed class SupplierManagementDbContext(
    DbContextOptions<SupplierManagementDbContext> options,
...
{
    protected override string TablePrefix => "suppliermanagement_";
}
