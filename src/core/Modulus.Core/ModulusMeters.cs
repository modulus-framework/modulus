...
public static class ModulusMeters
{
    ...
    public static Counter<long> OutboxDispatched => Outbox.CreateCounter<long>(
    ...
    public static Counter<long> OutboxDeadLettered => Outbox.CreateCounter<long>(
    ...
    public static UpDownCounter<long> OutboxDepth => Outbox.CreateUpDownCounter<long>(
    ...
    public static Counter<long> InboxDedupHits => Inbox.CreateCounter<long>(
    ...
    public static Counter<long> InboxDeadLettered => Inbox.CreateCounter<long>(
    ...
    public static Counter<long> JobsStarted => BackgroundJobs.CreateCounter<long>(
    ...
    public static Counter<long> JobsCompleted => BackgroundJobs.CreateCounter<long>(
    ...
    public static Counter<long> JobsFailed => BackgroundJobs.CreateCounter<long>(
        "modulus.jobs.failed",
        unit: "1",
    ...
    public static UpDownCounter<long> JobsQueueDepth => BackgroundJobs.CreateUpDownCounter<long>(
    ...
    public static UpDownCounter<long> RecurringJobCount => BackgroundJobs.CreateUpDownCounter<long>(
    ...
    public static Counter<long> RateLimitRejected => RateLimiting.CreateCounter<long>(
    ...
    public static UpDownCounter<long> RateLimitPartitions => RateLimiting.CreateUpDownCounter<long>(
    ...
    public static Counter<long> UnresolvedTenant => MultiTenancy.CreateCounter<long>(
